...
function onJoinChannel(cid, channel, users)
    ...
    if (channel >= CHANNEL_1_POKEMON and channel <= CHANNEL_PACIFIDLOG and
		...
		elseif (channel == CHANNEL_TURTWIG) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_TURTWIG))
		elseif (channel == CHANNEL_GROTLE) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_GROTLE))
		elseif (channel == CHANNEL_TORTERRA) then
            doPlayerPopupFYI(cid, getCaughtHighscoreText(HIGHSCORE_ID_CAUGHT_TORTERRA))
